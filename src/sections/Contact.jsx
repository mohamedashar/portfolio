  ...
  return (
    ...
    >
      <Wrapper
        ...
        className="rounded-3xl bg-[#0b0f0d]/80 border border-[#00ff66]/25 px-6 py-7 flex items-center gap-4 transition-all duration-300 group-hover:border-[#00ff66]/50 group-hover:shadow-[0_25px_70px_rgba(0,255,102,0.18)]"
      >
